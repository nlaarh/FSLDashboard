...
def get_driver_revenue_export(
    ...
    for row in [
        ...
        ['Note', 'Revenue = WOLI cost fields (Basic+Plus+Premier+RV+Other). Available immediately on call completion. Battery excluded from Tow/Light.'],
    ]:
        ws.append(row)
...
def _build_email_html(garage_name: str, start_date: str, end_date: str,
    ...
    return (
        ...
        f'Revenue = WOLI cost fields (Basic+Plus+Premier+RV+Other) · Available before invoicing · Battery excluded from Tow/Light · '
