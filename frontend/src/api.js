...
export const fetchAcceptance = (id, start, end) =>
  api.get(`/garages/${id}/acceptance?period_start=${start}&period_end=${end}`).then(r => r.data)
...
export const adminSystemHealthPing = (pin, serviceKey) => api.post(`/admin/system/health/ping/${serviceKey}`, null, pinHeader(pin)).then(r => r.data)
export const adminSystemHealthBackup = (pin) => api.post('/admin/system/health/backup', null, pinHeader(pin)).then(r => r.data)
...
export const adminRestoreUser = (pin, username) => api.post(`/admin/users/${username}/restore`, null, pinHeader(pin)).then(r => r.data)
export const adminImpersonate = (pin, username) => api.post(`/admin/users/${username}/impersonate`, null, pinHeader(pin)).then(r => r.data)
