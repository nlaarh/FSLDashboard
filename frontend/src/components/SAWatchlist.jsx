    ...
    <div className="bg-slate-800/50 backdrop-blur border border-red-800/40 rounded-xl overflow-hidden">
      <div className="flex items-center gap-2 px-4 py-2.5 border-b border-slate-700/50 bg-red-950/20">
        ...
        <span className="ml-auto flex items-center gap-3">
          <button onClick={handleCopy} className="text-slate-400 hover:text-emerald-300 transition-colors group relative" title="Copy table to clipboard">
            {copied
              ? <Check className="w-4 h-4 text-emerald-400" />
              : <Clipboard className="w-4 h-4" />}
            <span className="absolute top-full right-0 mt-2 hidden group-hover:block w-48 text-[10px] text-slate-200 bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 shadow-xl z-50 whitespace-normal">
              Copy table to clipboard. Paste into any document or chat.
            </span>
          </button>
